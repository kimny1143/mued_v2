...
import { Modal, ModalHeader, ModalTitle } from "../../components/ui/dialog";
...
export function ExerciseDetailPage() {
  ...
  const [autoLogData, setAutoLogData] = useState<any>(null);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {showLogForm ? (
              <Card className="p-6 relative overflow-hidden border-0 shadow-lg rounded-xl">
                ...
                {/* @ts-ignore - initialDataプロパティの型定義エラーを一時的に無視。後で修正する必要あり */}
