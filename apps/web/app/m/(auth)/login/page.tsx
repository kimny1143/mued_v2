...
export default function MobileLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white px-4">
      {/* Logo */}
      <div className="mb-8">
        <img src="/logo.png" alt="MUED LMS" className="h-16 w-auto" />
      </div>

      {/* Title */}
      <h1 className="text-2xl font-bold text-gray-900 mb-2">MUED LMS</h1>
      <p className="text-gray-600 mb-8 text-center">音楽レッスン管理システム</p>
        ...
        >
          {loading ? (
            <>
              ...
              <span className="text-gray-700">ログイン中...</span>
            </>
          ) : (
            <>
