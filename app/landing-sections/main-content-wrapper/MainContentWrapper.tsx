      ...
      <div className="flex flex-col items-start relative flex-1 grow">
        <div className="flex flex-col items-start gap-12 py-12 relative self-stretch w-full flex-[0_0_auto] bg-white">
          <div className="gap-4 px-4 sm:px-24 py-0 flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
            ...
            <p className="relative self-stretch font-flow font-normal text-[#000000cc] text-xl sm:text-2xl text-center tracking-[0] leading-8">
                ...
                >
                  <CardContent className="p-0 flex flex-col gap-6">
                    <div className="gap-4 flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                      <div className="relative self-stretch mt-[-1.00px] font-flow font-normal text-[#000000cc] text-xl tracking-[0] leading-7">
                        {plan.name}
                      </div>
                      ...
                      <div className="flex items-baseline gap-1 relative self-stretch w-full flex-[0_0_auto]">
                        ...
                        {plan.period && (
                          <div className="relative flex-1 font-flow font-normal text-[#000000cc] text-xl tracking-[0] leading-7">
                            {plan.period}
                          </div>
                        )}
                      </div>
                      ...
                      <div
                        className={`relative self-stretch font-flow font-normal ${
                          plan.highlighted ? "text-[#000000cc]" : "text-[#00000066]"
                        } text-lg tracking-[0] leading-6`}
                      >
                        {plan.audience}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-start gap-3 relative self-stretch w-full flex-[0_0_auto]">
                      {plan.features.map((feature, featureIndex) => (
                        ...
                        >
                          ...
                          <div
                            className={`relative flex-1 font-flow font-normal ${
                              plan.highlighted && index === 1
                                ? "text-[#000000cc]"
                                : "text-[#00000066]"
                            } text-base tracking-[0] leading-6`}
                          >
                            {feature}
                          </div>
                        </div>
